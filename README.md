...
**Flowparser**:
I have constructed an ETL with Tweakstreet to parse a set of Tweakstreet flows and send the results to Neo4j to visualize them. You can get it here: https://github.com/uwegeercken/tweakstreet-flowparser. It may serve to find out which and how many steps are typically used in a set of flows. Below is a little sample what it looks like in Neo4j Bloom.
